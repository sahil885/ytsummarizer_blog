...
export const allPosts: PostListEntry[] = [
  // Batch 6 (Sep 2026): adjacent failure modes. Query-verified gaps were largely
  // exhausted by Batch 5 (remainder are 1-4 impressions each), and GSC only
  // surfaces queries we already impress for — it cannot reveal demand for topics
  // with no page at all. So this batch extends the proven shape into untouched
  // ground, with four topics still anchored in observed queries: "you-tldr
  // alternative", "best youtube video summary prompt", "notegpt delete account"
  // (4 impr), and the transcript/caption-mismatch cluster.
  { slug: 'youtube-transcript-only-showing-partial', title: "YouTube Transcript Only Showing Part of the Video? Why", description: "Transcript stops halfway, starts late, or skips whole sections? The four reasons a caption track comes up short, and how to tell a display problem from a genuine gap.", date: '2026-09-22' },
  { slug: 'copy-youtube-transcript-not-working', title: "Can't Copy a YouTube Transcript? Here's What Works", description: "Selection jumping, copy pasting nothing, or timestamps ruining the text? Why copying from the transcript panel misbehaves, and the sequence that gets clean text every time.", date: '2026-09-22' },
  { slug: 'youtube-auto-translate-captions-wrong', title: "YouTube Auto-Translate Captions Wrong or Nonsense? Fix", description: "Auto-translated captions reading like gibberish, or translating a video already in your language? Why it happens, how to turn it off, and when to distrust the text.", date: '2026-09-22' },
  { slug: 'youtube-summary-repetitive-duplicate', title: "AI Summary Repeating the Same Points? Why It Happens", description: "Summary that says the same thing three times, or lists near-identical bullets? The causes — chunked processing, repetitive source material, weak prompts — and fixes.", date: '2026-09-22' },
  { slug: 'youtube-summarizer-not-working-safari', title: "YouTube Summarizer Not Working in Safari? Causes and Fixes", description: "Summarizer extension missing in Safari, or blocked by tracking prevention? Why Safari behaves differently from Chrome, what you can change, and what you cannot.", date: '2026-09-22' },
  { slug: 'youtube-summarizer-not-working-ipad', title: "YouTube Summarizer Not Working on iPad? What Actually Works", description: "Expecting your desktop summarizer to work on iPad and finding nothing? Why iPadOS behaves like a phone here despite desktop-class browsing, and the setup that works.", date: '2026-09-22' },
  { slug: 'grok-youtube-summary-not-working', title: "Grok Not Summarizing YouTube Videos? Causes and Fixes", description: "Grok returning a vague summary, refusing a YouTube link, or describing a video it never processed? What Grok can actually read, and how to spot a guessed summary.", date: '2026-09-22' },
  { slug: 'chatgpt-atlas-youtube-summary-not-working', title: "ChatGPT Atlas Not Summarizing YouTube? Causes and Fixes", description: "Atlas sidebar failing on a YouTube video, or summarizing the page instead of the content? What Atlas can read, the availability limits, and how to check a summary is real.", date: '2026-09-22' },
  { slug: 'best-youtube-summary-prompt', title: "The Best Prompts for Summarizing a YouTube Video (2026)", description: "Copy-paste prompts that produce useful video summaries instead of vague paragraphs — for lectures, interviews, tutorials and podcasts, plus how to get the transcript first.", date: '2026-09-22' },
  { slug: 'you-tldr-alternative', title: "You-TLDR Alternatives: 5 YouTube Summarizers Compared", description: "Looking for a You-TLDR alternative for transcripts and summaries? Five options compared on output quality, long-video handling, signup requirements and what each costs.", date: '2026-09-22' },
  { slug: 'notegpt-delete-account', title: "How to Delete Your NoteGPT Account (and Cancel First)", description: "Deleting a NoteGPT account? Cancel the subscription first or billing can continue, export anything you want to keep, and know what deletion does and does not remove.", date: '2026-09-22' },
  { slug: 'youtube-transcript-doesnt-match-audio', title: "YouTube Transcript Doesn't Match the Audio? Why It Happens", description: "Captions saying something different from what you hear? Where automatic recognition fails most, which errors matter, and how to check a summary built on a faulty transcript.", date: '2026-09-22' },
  ...
  { slug: 'summarize-tech-alternative', title: "Summarize.tech Alternatives: 6 Tools With Better Output", description: "Summarize.tech is free and hands you a wall of paragraphs. Six alternatives with structured key points, saved summaries and reliable long-video handling — free and paid.", date: '2026-08-16' },
  ...
  { slug: 'youtube-no-transcript-available-fix', title: "\"No Transcript Available\" on YouTube? Here’s Why (2026)", description: "YouTube says no transcript is available on a video you can watch perfectly. The four reasons it happens, which ones you can actually fix, and how to get a summary anyway.", date: '2026-08-16' },
  ...
  { slug: 'chatgpt-wont-open-youtube-link', title: "Why ChatGPT Can’t Open YouTube Links (And What Works)", description: "Paste a YouTube URL into ChatGPT and you can get a confident summary of a video it never watched. Why that happens, how to spot it, and the workflow that actually works.", date: '2026-08-16' },
  ...
  { slug: 'private-age-restricted-video-summarize', title: "Can't Summarize a Private or Age-Restricted YouTube Video? Here's Why", description: "Summarizer failing on a private, unlisted, members-only or age-restricted video? Which types are actually blocked, which work, and what your options are for each.", date: '2026-08-16' },
  ...
  { slug: 'how-to-remove-timestamps-from-youtube-transcript', title: "Remove Timestamps From a YouTube Transcript in 2 Clicks", description: "YouTube has a hidden toggle that strips timestamps before you copy. Most people never find it and delete hundreds of lines by hand. Here is where it is, plus 3 backups.", date: '2026-07-28' },
  ...
  { slug: 'ytsummarizer-pricing-is-it-worth-it', title: "YT Summarizer Pricing: Is It Worth It in 2026?", description: "YT Summarizer uses one-time summary packs, not a subscription. We break down the free tier, the $19/$49 packs, the value math vs monthly tools, and who should buy which.", date: '2026-06-07' },
  ...
  },
  {
    ...
    description: "AI summarizers don't watch video — they read the caption track. What that means for accuracy, why long videos get cut off, and how to spot a summary that guessed.",
    date: '2026-05-01',
  },
  {
  ...
  {
    slug: 'youtube-summarizer-for-financial-professionals',
    title: 'YouTube Summarizer for Financial Professionals: Stay on Top of Market Content Without the Watch Time',
    description: 'Financial advisors, analysts, and investors use AI YouTube summarizers to scan market commentary, earnings calls, and macro content without watching hours of video. Here\'s how.',
    date: '2026-04-20',
  },
  {
    slug: 'youtube-summarizer-for-developers',
    title: 'YouTube Summarizer for Developers: Stop Watching Tutorials You Don\'t Need',
    description: 'Developers use AI YouTube summarizers to pre-screen tech talks, tutorials, and conference videos before committing watch time. Here\'s the workflow that actually saves hours.',
    date: '2026-04-20',
  },
  {
  ...
  },
  {
    ...
    description: 'NoteGPT or YT Summarizer? We compared both on pricing, accuracy, features, and long-term cost. Full head-to-head breakdown for students, researchers, and casual users in 2026.',
    date: '2026-04-18',
  },
  {
    slug: 'how-to-summarize-a-2-hour-youtube-video-in-under-5-minutes',
    title: 'How to Summarize a 2-Hour YouTube Video in Under 5 Minutes',
    description: 'Step-by-step guide to summarizing long YouTube videos (2 hours or more) using AI in under 5 minutes. Covers the workflow, common mistakes, and when AI summaries fall short.',
    date: '2026-04-18',
  },
  {
    slug: 'can-chatgpt-summarize-youtube-videos',
    title: "Can ChatGPT Summarize a YouTube Video? Yes — Here’s How",
    description: "ChatGPT cannot open YouTube links, but it summarizes transcripts well. The exact workflow, a copy-paste prompt, and why it quietly fails on videos over an hour long.",
    date: '2026-07-03',
  },
  {
  ...
  { slug: 'free-ai-tool-to-summarize-youtube-videos', title: "Free AI YouTube Summarizers: What Each One Limits (2026)", description: "Every free YouTube summarizer has a catch — a daily cap, a weekly quota, or a paywall that appears on long videos. Exactly where each one stops, and which to pick.", date: '2026-03-16' },
  ...
  { slug: 'top-5-free-ai-tools', title: "5 Free YouTube Video Summarizers, Tested (2026)", description: "We ran the same videos through five free YouTube summarizers. Which produced usable key points, which cut off on long videos, and where each one's paywall really starts.", date: '2026-03-16' },
